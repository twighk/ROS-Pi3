//#line 2 "/opt/ros_catkin_ws/src/dynamic_reconfigure/templates/ConfigType.h.template"
// *********************************************************
// 
...
//#line 280 "/opt/ros_catkin_ws/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
      int int_enum_;
//#line 280 "/opt/ros_catkin_ws/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
      int int_;
//#line 280 "/opt/ros_catkin_ws/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 280 "/opt/ros_catkin_ws/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
      int i;
//#line 61 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      int group1_int;
//#line 63 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      double group2_double;
//#line 64 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      std::string group2_string;
//#line 65 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      std::string some_other;
//#line 66 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      bool variable;
//#line 68 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      int deep_var_int;
//#line 69 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      bool deep_var_bool;
//#line 72 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      int some_param;
//#line 218 "/opt/ros_catkin_ws/src/dynamic_reconfigure/templates/ConfigType.h.template"
...
//#line 280 "/opt/ros_catkin_ws/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TestConfig::AbstractParamDescriptionConstPtr(new TestConfig::ParamDescription<int>("int_enum_", "int", 1, "Int enum", "{'enum_description': 'An enum to set the size.', 'enum': [{'srcline': 45, 'description': 'A small constant', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Small'}, {'srcline': 46, 'description': 'A medium value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Medium'}, {'srcline': 47, 'description': 'A large value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Large'}, {'srcline': 48, 'description': 'An extra large value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ExtraLarge'}]}", &TestConfig::int_enum_)));
//#line 280 "/opt/ros_catkin_ws/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 68 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      Group3.abstract_parameters.push_back(TestConfig::AbstractParamDescriptionConstPtr(new TestConfig::ParamDescription<int>("deep_var_int", "int", 0, "Were very far down now", "{'enum_description': 'An enum to set the size.', 'enum': [{'srcline': 45, 'description': 'A small constant', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Small'}, {'srcline': 46, 'description': 'A medium value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Medium'}, {'srcline': 47, 'description': 'A large value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Large'}, {'srcline': 48, 'description': 'An extra large value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ExtraLarge'}]}", &TestConfig::deep_var_int)));
//#line 68 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      __param_descriptions__.push_back(TestConfig::AbstractParamDescriptionConstPtr(new TestConfig::ParamDescription<int>("deep_var_int", "int", 0, "Were very far down now", "{'enum_description': 'An enum to set the size.', 'enum': [{'srcline': 45, 'description': 'A small constant', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Small'}, {'srcline': 46, 'description': 'A medium value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Medium'}, {'srcline': 47, 'description': 'A large value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Large'}, {'srcline': 48, 'description': 'An extra large value', 'srcfile': '/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ExtraLarge'}]}", &TestConfig::deep_var_int)));
//#line 69 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
...
//#line 109 "/opt/ros_catkin_ws/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 235 "/opt/ros_catkin_ws/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 353 "/opt/ros_catkin_ws/src/dynamic_reconfigure/templates/ConfigType.h.template"
...
//#line 40 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      const int Test_int_const = 5;
//#line 41 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      const double Test_double_const = 5.6;
//#line 42 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      const char * const Test_str_const = "foo";
//#line 43 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      const bool Test_bool_const = 1;
//#line 45 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      const int Test_Small = 0;
//#line 46 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      const int Test_Medium = 1;
//#line 47 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
      const int Test_Large = 2;
//#line 48 "/opt/ros_catkin_ws/src/dynamic_reconfigure/cfg/Test.cfg"
