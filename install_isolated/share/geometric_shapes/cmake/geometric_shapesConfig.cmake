...
if(NOT "include;/opt/ros_catkin_ws/install_isolated/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros_catkin_ws/install_isolated/include;/usr/include/eigen3;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/install_isolated/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Dave Coleman <dave@dav.ee>' to fix it.")
    endif()
