...
if(NOT "/opt/ros_catkin_ws/src/rosconsole_bridge/include;/usr/include " STREQUAL " ")
  set(rosconsole_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros_catkin_ws/src/rosconsole_bridge/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/rosconsole_bridge/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>, Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/rosconsole_bridge/lib;/opt/ros_catkin_ws/install_isolated/lib)
