...
if("TRUE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /opt/ros_catkin_ws/src/pluginlib)
  set(pluginlib_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/pluginlib)
  ...
  set(pluginlib_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT "/opt/ros_catkin_ws/src/pluginlib/include;/usr/include " STREQUAL " ")
  set(pluginlib_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros_catkin_ws/src/pluginlib/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/pluginlib/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/pluginlib/lib;/opt/ros_catkin_ws/install_isolated/lib)
