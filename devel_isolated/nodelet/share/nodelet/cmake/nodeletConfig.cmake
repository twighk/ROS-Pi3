...
if("TRUE" STREQUAL "TRUE")
  set(nodelet_SOURCE_PREFIX /opt/ros_catkin_ws/src/nodelet_core/nodelet)
  set(nodelet_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/nodelet)
  set(nodelet_INSTALL_PREFIX "")
  set(nodelet_PREFIX ${nodelet_DEVEL_PREFIX})
else()
  set(nodelet_SOURCE_PREFIX "")
  set(nodelet_DEVEL_PREFIX "")
  set(nodelet_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT "/opt/ros_catkin_ws/devel_isolated/nodelet/include;/opt/ros_catkin_ws/src/nodelet_core/nodelet/include;/usr/include " STREQUAL " ")
  set(nodelet_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros_catkin_ws/devel_isolated/nodelet/include;/opt/ros_catkin_ws/src/nodelet_core/nodelet/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/nodelet_core/nodelet/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/nodelet/lib;/opt/ros_catkin_ws/install_isolated/lib)
