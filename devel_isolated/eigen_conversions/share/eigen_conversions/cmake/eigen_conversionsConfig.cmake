...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /opt/ros_catkin_ws/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/eigen_conversions)
  ...
  set(eigen_conversions_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT "/opt/ros_catkin_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros_catkin_ws/install_isolated/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros_catkin_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros_catkin_ws/install_isolated/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/geometry/eigen_conversions/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;/opt/ros_catkin_ws/install_isolated/lib/liborocos-kdl.so.1.3.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/eigen_conversions/lib;/opt/ros_catkin_ws/install_isolated/lib)
