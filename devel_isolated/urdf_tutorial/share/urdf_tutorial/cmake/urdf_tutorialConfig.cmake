...
if("TRUE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /opt/ros_catkin_ws/src/urdf_tutorial)
  set(urdf_tutorial_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/urdf_tutorial)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/urdf_tutorial/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/urdf_tutorial/lib;/opt/ros_catkin_ws/install_isolated/lib)
