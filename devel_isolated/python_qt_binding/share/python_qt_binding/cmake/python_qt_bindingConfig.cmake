...
if("TRUE" STREQUAL "TRUE")
  set(python_qt_binding_SOURCE_PREFIX /opt/ros_catkin_ws/src/python_qt_binding)
  set(python_qt_binding_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/python_qt_binding)
  ...
  set(python_qt_binding_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'python_qt_binding' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/python_qt_binding/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/python_qt_binding/lib;/opt/ros_catkin_ws/install_isolated/lib)
