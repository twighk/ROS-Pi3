...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /opt/ros_catkin_ws/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/image_geometry)
  ...
  set(image_geometry_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT "/opt/ros_catkin_ws/src/vision_opencv/image_geometry/include;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros_catkin_ws/src/vision_opencv/image_geometry/include;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/vision_opencv/image_geometry/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/image_geometry/lib;/opt/ros_catkin_ws/install_isolated/lib)
