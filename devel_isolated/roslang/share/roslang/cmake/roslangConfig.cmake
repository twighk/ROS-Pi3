...
if("TRUE" STREQUAL "TRUE")
  set(roslang_SOURCE_PREFIX /opt/ros_catkin_ws/src/ros/roslang)
  set(roslang_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/roslang)
  set(roslang_INSTALL_PREFIX "")
  set(roslang_PREFIX ${roslang_DEVEL_PREFIX})
else()
  set(roslang_SOURCE_PREFIX "")
  set(roslang_DEVEL_PREFIX "")
  set(roslang_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/ros/roslang/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/roslang/lib;/opt/ros_catkin_ws/install_isolated/lib)
