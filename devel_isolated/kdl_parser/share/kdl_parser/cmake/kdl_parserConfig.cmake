...
if("TRUE" STREQUAL "TRUE")
  set(kdl_parser_SOURCE_PREFIX /opt/ros_catkin_ws/src/robot_model/kdl_parser)
  set(kdl_parser_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/kdl_parser)
  ...
  set(kdl_parser_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT "/opt/ros_catkin_ws/src/robot_model/kdl_parser/include;/usr/include/eigen3;/opt/ros_catkin_ws/install_isolated/include;/usr/include " STREQUAL " ")
  set(kdl_parser_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros_catkin_ws/src/robot_model/kdl_parser/include;/usr/include/eigen3;/opt/ros_catkin_ws/install_isolated/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/robot_model/kdl_parser/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()
    _list_append_unique(kdl_parser_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "kdl_parser;/opt/ros_catkin_ws/install_isolated/lib/liborocos-kdl.so;/opt/ros_catkin_ws/install_isolated/lib/liborocos-kdl.so.1.3.0;/usr/lib/arm-linux-gnueabihf/libtinyxml.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/kdl_parser/lib;/opt/ros_catkin_ws/install_isolated/lib)
