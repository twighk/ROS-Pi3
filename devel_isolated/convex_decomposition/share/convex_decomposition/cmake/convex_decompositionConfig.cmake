...
if("TRUE" STREQUAL "TRUE")
  set(convex_decomposition_SOURCE_PREFIX /opt/ros_catkin_ws/src/convex_decomposition)
  set(convex_decomposition_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/convex_decomposition)
  ...
  set(convex_decomposition_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'convex_decomposition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/convex_decomposition/${idir}'.  Ask the maintainer 'Bryce Vondervoort <bvondervoort@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/convex_decomposition/lib;/opt/ros_catkin_ws/install_isolated/lib)
