...
if("TRUE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /opt/ros_catkin_ws/src/pr2_common/pr2_description)
  set(pr2_description_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/pr2_description)
  ...
  set(pr2_description_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/pr2_common/pr2_description/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/pr2_description/lib;/opt/ros_catkin_ws/install_isolated/lib)
