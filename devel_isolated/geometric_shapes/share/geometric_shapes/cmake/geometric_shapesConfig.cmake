...
if("TRUE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /opt/ros_catkin_ws/src/geometric_shapes)
  set(geometric_shapes_DEVEL_PREFIX /opt/ros_catkin_ws/devel_isolated/geometric_shapes)
  ...
  set(geometric_shapes_INSTALL_PREFIX /opt/ros_catkin_ws/install_isolated)
...
if(NOT "/opt/ros_catkin_ws/src/geometric_shapes/include;/opt/ros_catkin_ws/install_isolated/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros_catkin_ws/src/geometric_shapes/include;/opt/ros_catkin_ws/install_isolated/include;/usr/include/eigen3;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros_catkin_ws/src/geometric_shapes/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Dave Coleman <dave@dav.ee>' to fix it.")
    endif()
    _list_append_unique(geometric_shapes_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "geometric_shapes;/opt/ros_catkin_ws/install_isolated/lib/liboctomap.so;/opt/ros_catkin_ws/install_isolated/lib/liboctomath.so;/usr/lib/arm-linux-gnueabihf/libconsole_bridge.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros_catkin_ws/devel_isolated/geometric_shapes/lib;/opt/ros_catkin_ws/install_isolated/lib)
