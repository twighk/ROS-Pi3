...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/shape_msgs/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/shape_msgs/catkin_generated/setup_cached.sh'
