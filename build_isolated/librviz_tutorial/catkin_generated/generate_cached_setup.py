...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/librviz_tutorial/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/librviz_tutorial/catkin_generated/setup_cached.sh'
