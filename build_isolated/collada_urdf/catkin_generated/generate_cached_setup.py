...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/collada_urdf/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/collada_urdf/catkin_generated/setup_cached.sh'
