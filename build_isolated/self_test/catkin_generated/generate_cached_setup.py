...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/self_test/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/self_test/catkin_generated/setup_cached.sh'
