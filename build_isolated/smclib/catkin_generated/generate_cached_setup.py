...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/smclib/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/smclib/catkin_generated/setup_cached.sh'
