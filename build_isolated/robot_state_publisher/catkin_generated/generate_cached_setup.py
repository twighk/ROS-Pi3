...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/robot_state_publisher/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/robot_state_publisher/catkin_generated/setup_cached.sh'
