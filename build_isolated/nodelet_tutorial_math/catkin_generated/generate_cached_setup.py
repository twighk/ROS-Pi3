...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/nodelet_tutorial_math/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/nodelet_tutorial_math/catkin_generated/setup_cached.sh'
