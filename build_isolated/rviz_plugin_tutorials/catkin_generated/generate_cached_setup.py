...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rviz_plugin_tutorials/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rviz_plugin_tutorials/catkin_generated/setup_cached.sh'
