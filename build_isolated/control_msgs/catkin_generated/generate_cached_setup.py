...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/control_msgs/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/control_msgs/catkin_generated/setup_cached.sh'
