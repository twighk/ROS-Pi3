...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rosparam/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rosparam/catkin_generated/setup_cached.sh'
