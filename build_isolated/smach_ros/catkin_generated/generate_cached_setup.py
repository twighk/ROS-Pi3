...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/smach_ros/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/smach_ros/catkin_generated/setup_cached.sh'
