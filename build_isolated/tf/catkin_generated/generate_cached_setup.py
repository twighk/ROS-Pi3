...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/tf/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/tf/catkin_generated/setup_cached.sh'
