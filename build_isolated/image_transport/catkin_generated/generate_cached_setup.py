...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/image_transport/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/image_transport/catkin_generated/setup_cached.sh'
