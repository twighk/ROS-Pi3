...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/eigen_stl_containers/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/eigen_stl_containers/catkin_generated/setup_cached.sh'
