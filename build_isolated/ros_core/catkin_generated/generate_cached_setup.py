...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/ros_core/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/ros_core/catkin_generated/setup_cached.sh'
