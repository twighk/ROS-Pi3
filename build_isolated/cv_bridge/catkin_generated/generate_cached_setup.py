...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/cv_bridge/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/cv_bridge/catkin_generated/setup_cached.sh'
