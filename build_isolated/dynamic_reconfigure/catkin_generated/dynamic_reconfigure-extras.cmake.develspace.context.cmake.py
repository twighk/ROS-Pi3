...
CATKIN_DEVEL_PREFIX = '/opt/ros_catkin_ws/devel_isolated/dynamic_reconfigure'
...
CMAKE_CURRENT_BINARY_DIR = '/opt/ros_catkin_ws/build_isolated/dynamic_reconfigure'
CMAKE_CURRENT_SOURCE_DIR = '/opt/ros_catkin_ws/src/dynamic_reconfigure'
CMAKE_INSTALL_PREFIX = '/opt/ros_catkin_ws/install_isolated'
CMAKE_SOURCE_DIR = '/opt/ros_catkin_ws/src/dynamic_reconfigure'

PKG_CMAKE_DIR = '/opt/ros_catkin_ws/devel_isolated/dynamic_reconfigure/share/dynamic_reconfigure/cmake'

PROJECT_NAME = 'dynamic_reconfigure'
PROJECT_BINARY_DIR = '/opt/ros_catkin_ws/build_isolated/dynamic_reconfigure'
PROJECT_SOURCE_DIR = '/opt/ros_catkin_ws/src/dynamic_reconfigure'
