...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/desktop/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/desktop/catkin_generated/setup_cached.sh'
