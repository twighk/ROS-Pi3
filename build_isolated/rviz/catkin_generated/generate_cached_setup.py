...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rviz/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rviz/catkin_generated/setup_cached.sh'
