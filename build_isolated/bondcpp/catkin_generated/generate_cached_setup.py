...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/bondcpp/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/bondcpp/catkin_generated/setup_cached.sh'
