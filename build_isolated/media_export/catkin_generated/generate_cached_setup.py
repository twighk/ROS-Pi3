...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/media_export/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/media_export/catkin_generated/setup_cached.sh'
