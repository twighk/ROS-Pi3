...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rqt_gui/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rqt_gui/catkin_generated/setup_cached.sh'
