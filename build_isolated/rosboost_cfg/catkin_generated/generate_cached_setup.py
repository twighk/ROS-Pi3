...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rosboost_cfg/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rosboost_cfg/catkin_generated/setup_cached.sh'
