...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/diagnostic_updater/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/diagnostic_updater/catkin_generated/setup_cached.sh'
