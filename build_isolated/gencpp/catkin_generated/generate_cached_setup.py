...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/gencpp/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/gencpp/catkin_generated/setup_cached.sh'
