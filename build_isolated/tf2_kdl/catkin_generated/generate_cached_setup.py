...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/tf2_kdl/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/tf2_kdl/catkin_generated/setup_cached.sh'
