...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rqt_action/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rqt_action/catkin_generated/setup_cached.sh'
