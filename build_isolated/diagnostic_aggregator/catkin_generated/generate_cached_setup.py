...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/diagnostic_aggregator/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/diagnostic_aggregator/catkin_generated/setup_cached.sh'
