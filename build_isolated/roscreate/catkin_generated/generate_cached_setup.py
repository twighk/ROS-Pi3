...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/roscreate/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/roscreate/catkin_generated/setup_cached.sh'
