...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/kdl_parser/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/kdl_parser/catkin_generated/setup_cached.sh'
