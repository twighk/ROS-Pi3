...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/message_generation/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/message_generation/catkin_generated/setup_cached.sh'
