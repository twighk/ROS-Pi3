...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/geneus/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/geneus/catkin_generated/setup_cached.sh'
