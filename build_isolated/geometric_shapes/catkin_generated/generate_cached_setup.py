...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/geometric_shapes/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/geometric_shapes/catkin_generated/setup_cached.sh'
