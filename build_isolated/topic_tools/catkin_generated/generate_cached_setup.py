...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/topic_tools/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/topic_tools/catkin_generated/setup_cached.sh'
