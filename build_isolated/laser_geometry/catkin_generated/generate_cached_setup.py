...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/laser_geometry/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/laser_geometry/catkin_generated/setup_cached.sh'
