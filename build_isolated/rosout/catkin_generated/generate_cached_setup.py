...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rosout/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rosout/catkin_generated/setup_cached.sh'
