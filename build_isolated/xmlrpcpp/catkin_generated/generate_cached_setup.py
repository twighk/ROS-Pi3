...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/xmlrpcpp/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/xmlrpcpp/catkin_generated/setup_cached.sh'
