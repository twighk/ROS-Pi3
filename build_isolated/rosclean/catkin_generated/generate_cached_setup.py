...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rosclean/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rosclean/catkin_generated/setup_cached.sh'
