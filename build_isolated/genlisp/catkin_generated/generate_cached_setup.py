...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/genlisp/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/genlisp/catkin_generated/setup_cached.sh'
