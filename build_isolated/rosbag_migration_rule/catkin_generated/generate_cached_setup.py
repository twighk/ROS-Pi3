...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rosbag_migration_rule/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rosbag_migration_rule/catkin_generated/setup_cached.sh'
