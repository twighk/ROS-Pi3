...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/convex_decomposition/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/convex_decomposition/catkin_generated/setup_cached.sh'
