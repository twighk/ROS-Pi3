...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/nav_msgs/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/nav_msgs/catkin_generated/setup_cached.sh'
