...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/urdf_parser_plugin/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/urdf_parser_plugin/catkin_generated/setup_cached.sh'
