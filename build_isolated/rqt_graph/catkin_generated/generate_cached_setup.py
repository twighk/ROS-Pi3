...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/rqt_graph/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/rqt_graph/catkin_generated/setup_cached.sh'
