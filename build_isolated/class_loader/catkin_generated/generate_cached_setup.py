...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/class_loader/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/class_loader/catkin_generated/setup_cached.sh'
