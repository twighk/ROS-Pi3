...
code = generate_environment_script('/opt/ros_catkin_ws/devel_isolated/qt_gui_py_common/env.sh')

output_filename = '/opt/ros_catkin_ws/build_isolated/qt_gui_py_common/catkin_generated/setup_cached.sh'
